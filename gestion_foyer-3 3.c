...
void afficher_tous_etudiants() {
    ...
    for ( i = 0; i < nb_etudiants; i++) afficher_etudiant(tab_etudiants[i]);
    printf("\n  Total : %d etudiant(s).\n", nb_etudiants);
    pause_attente();
}
...
void supprimer_etudiant() {
    ...
    if (conf == 'o' || conf == 'O') {
        for ( i = idx; i < nb_etudiants - 1; i++) tab_etudiants[i] = tab_etudiants[i+1];
        nb_etudiants--;
        printf("  [OK] Supprime.\n");
    } else printf("  Annule.\n");
    pause_attente();
...
void afficher_toutes_chambres() {
    ...
    for (i = 0; i < nb_chambres; i++) afficher_chambre(tab_chambres[i]);
    printf("\n  Total : %d chambre(s).\n", nb_chambres);
    pause_attente();
}
...
void supprimer_chambre() {
    ...
    char conf; scanf("%c", &conf); vider_buffer();
    if (conf == 'o' || conf == 'O') {
        for (i = idx; i < nb_chambres - 1; i++) tab_chambres[i] = tab_chambres[i+1];
        nb_chambres--;
...
void afficher_tous_paiements() {
    ...
    for (i = 0; i < nb_paiements; i++) afficher_paiement(tab_paiements[i]);
    printf("\n  Total : %d paiement(s).\n", nb_paiements);
    pause_attente();
}
...
void supprimer_paiement() {
    ...
    char conf; scanf("%c", &conf); vider_buffer();
    if (conf == 'o' || conf == 'O') {
        for ( i = idx; i < nb_paiements - 1; i++) tab_paiements[i] = tab_paiements[i+1];
        nb_paiements--;
        printf("  [OK] Supprime.\n");
    } else printf("  Annule.\n");
    pause_attente();
...
void afficher_toutes_reclamations() {
    ...
    for ( i = 0; i < nb_reclamations; i++) afficher_reclamation(tab_reclamations[i]);
...
void supprimer_reclamation() {
    ...
    char conf; scanf("%c", &conf); vider_buffer();
    if (conf == 'o' || conf == 'O') {
        for ( i = idx; i < nb_reclamations - 1; i++) tab_reclamations[i] = tab_reclamations[i+1];
        nb_reclamations--;
        printf("  [OK] Supprimee.\n");
    } else printf("  Annule.\n");
    pause_attente();
